...
class BarSharia extends React.Component {
  state = {
    tema1: 0,
    tema2: 0,
    tema3: 0,
  ...
  componentDidMount() {
    Axios({
      url: 'https://submission-api.ejavec.org/fetchShariaByTheme',
      method: 'POST',
      headers: {
  ...
  render() {
    ...
    const labels = ['Java Sharia Business Model']
