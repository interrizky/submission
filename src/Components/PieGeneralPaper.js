...
class PieGeneralPaper extends React.Component {
  state = {
    submitNumber: 0,
    nonSubmitNumber: 0
  }
  ...
  componentDidMount() {
    Axios({
      ...
      this.setState({ submitNumber: response.data.angkaGPSubmit, nonSubmitNumber: response.data.angkaGPNon })
    })
  }
  ...
  render() {
    const options = {
      ...
      plugins: {
        ...
        title: {
          display: true,
          text: 'General Paper By Status Pie Chart',
        },
      },
    }
...
export default PieGeneralPaper